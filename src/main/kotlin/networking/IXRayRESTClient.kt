...
interface IXRayRESTClient {
    suspend fun logInOnXRay(httpClient: HttpClient, xrayClientID:String, xrayClientSecret:String, importerViewModel: ImporterViewModel): Result<LoginResponse, NetworkError>
